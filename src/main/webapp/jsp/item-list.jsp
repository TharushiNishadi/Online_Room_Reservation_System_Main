...
<head>
    ...
    <title>Items - Ocean View Resort Room Reservation System</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="container my-4">
    <div class="row mb-4">
        <div class="col">
            <h2><i class="bi bi-box me-2"></i>Rooms Management</h2>
        </div>
        <div class="col text-end">
            ...
            <a href="${pageContext.request.contextPath}/item?action=add"
               class="btn btn-primary">
                <i class="bi bi-plus-circle me-2"></i>Add New Rooms
            </a>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">
                <i class="bi bi-list-ul me-2"></i>Rooms List
