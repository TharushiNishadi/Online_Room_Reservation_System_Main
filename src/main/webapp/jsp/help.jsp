...
<head>
    ...
    <title>Help - Ocean View Resort Online Reservation System</title>
    <!-- Bootstrap 5 CSS -->
...
<div class="container my-4">
    ...
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="bi bi-info-circle me-2"></i>About Ocean View Resort</h5>
        </div>
        <div class="card-body">
            <p class="lead">

                Ocean View Resort in Galle is a beachside hotel that currently manages room reservations manually, which can cause booking conflicts and delays. To improve efficiency, the resort plans to implement a computerized reservation system to manage guest details, bookings, and billing more effectively.
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="text-center">
                        ...
                        <p class="text-muted">Manage rooms, price management, and alerts.</p>
                    </div>
                </div>
                <div class="col-md-6 col-lg-3">
                    <div class="text-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="text-center">
                        ...
                        <p class="text-muted">View sales statistics, and business insights at a glance.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            ...
                            <i class="bi bi-box me-2"></i>Managing Rooms
                        </button>
                    </h2>
                    <div id="collapseThree" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            <ol>
                                <li>Navigate to Rooms section</li>
                                <li>Add new rooms with name, price, and stock quantity</li>
                                <li>Monitor stock levels (items below 10 units show warnings)</li>
                                <li>Update room prices and stock as needed</li>
                                <li>Delete room that are no longer needed</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body">
                            <ol>
                                ...
                                <li>Add rooms to the bill by selecting from available rooms</li>
