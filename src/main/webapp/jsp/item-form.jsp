...
<head>
    ...
    <title>${not empty item.id ? 'Edit' : 'Add'} Rooms - Ocean View Resort</title>
...
<div class="container my-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/item">Rooms</a></li>
            <li class="breadcrumb-item active">${not empty item.id ? 'Edit' : 'Add'} Rooms</li>
        </ol>
    </nav>
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        ...
                        ${not empty item.id ? 'Edit' : 'Add New'} Rooms
                    </h5>
                </div>
                    ...
                    <form action="${pageContext.request.contextPath}/item" method="post">
                        ...
                        <div class="mb-3">
                            <label for="itemName" class="form-label">
                                <i class="bi bi-box me-1"></i>Room Category <span class="text-danger">*</span>
                            </label>
                            <input type="text"
                                   class="form-control"
                                   id="itemName"
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="unitPrice" class="form-label">
                                    <span class="me-1">₨</span>Rooms Price (LKR) <span class="text-danger">*</span>
                                </label>
                                <input type="number"
                                       class="form-control"
                                       id="unitPrice"
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="stockQuantity" class="form-label">
                                    <i class="bi bi-boxes me-1"></i>Rooms Quantity <span class="text-danger">*</span>
                                </label>
                                <input type="number"
                                       class="form-control"
                                       id="stockQuantity"
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                ...
                                ${not empty item.id ? 'Update' : 'Save'} Room
                            </button>
                        </div>
                    </form>
                </div>
            ...
            <c:if test="${not empty item.id}">
                <div class="card mt-3">
                    <div class="card-body">
                        <h6 class="card-title">Rooms Information</h6>
                        <p class="mb-1">
                            <strong>Current Rooms:</strong>
                            <c:choose>
                                <c:when test="${item.stockQuantity == 0}">
                                    <span class="text-danger">Out of Rooms</span>
                                </c:when>
                        ...
                        <small class="text-muted">
                            ...
                            Rooms with less than 10 units are marked as low stock
                        </small>
                    </div>
                </div>
            </c:if>
