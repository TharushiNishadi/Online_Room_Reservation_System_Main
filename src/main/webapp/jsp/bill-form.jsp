...
<head>
    ...
    <title>Create New Bill - Ocean View Resort</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <form action="${pageContext.request.contextPath}/bill" method="post" id="billForm">
        ...
        <div class="card mb-4">
            <div class="card-header bg-success text-white">
                <h5 class="mb-0"><i class="bi bi-cart-check me-2"></i>Add Rooms</h5>
            </div>
            <div class="card-body">
                ...
                <button type="button" class="btn btn-success mt-3" onclick="addItemRow()">
                    <i class="bi bi-plus-circle me-2"></i>Add Another Rooms
                </button>
            </div>
        </div>
...
<script>
    ...
    function calculateRowTotal(rowIndex) {
        ...
        if (select.value && quantity > 0) {
            const price = roomPrices[select.value];
